...
const ProjectsPage = () => {
  return (
    <Container>
      <div className="flex flex-col gap-7.5 text-center pb-30 mt-5">
        <h2 className="main-title text-[60px]">My <span className="text-cyan-400">Portfolio</span></h2>
        ...
        <p className="text-sm tracking-wider leading-7">A collection of projects highlighting my growing expertise in modern frontend
