    ...
    <div className={`${page ? "mt-10" : "mt-30 xl:mt-45"}`}>
      ...
      <div className="mt-10 flex flex-col">
        {isFilteredData?.map((item, i) => (
          <div key={i}>
            <div className="grid grid-cols-2 gap-7 xl:gap-25 relative">
              ...
              <div className={`${i % 2 === 0 ? "col-start-2 row-start-1" : "col-start-1"} bg-gray-800 h-68 xl:h-90 rounded-2xl xl:rounded-[20px] overflow-hidden`}>
                <ProjectSwiper data={item.images} />
              </div>
              <div className={`${i % 2 === 0 ? "col-start-1" : "col-start-2 row-start-1"} flex flex-col space-y-4 xl:space-y-6 xl:p-5 pl-0! pb-0!`}>
                <div>
            ...
            <div className={`${isFilteredData.length - 1 === i && "hidden"} flex items-center justify-center py-7 xl:py-5 relative`}>
