  ...
  return (
    <div
      ...
      >
        ...
        <div className={`absolute h-px xl:h-0.5 transition-all duration-300 rounded-2xl ${isActive ? "w-full! left-0! bg-thirtyColor/80 bottom-0.5 xl:-bottom-0.5" : "w-0 bottom-0.5 xl:-bottom-0.5 left-1/2 bg-thirtyColor/50 group-hover:w-full! group-hover:left-0!"}`} />
      </Link>
    </div>
  )
}
