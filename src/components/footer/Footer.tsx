...
export const Footer = () => {
  return (
    <footer className="mt-26 xl:mt-41">
      <h2 className="main-title text-center flex items-center justify-center gap-1 sm:gap-3">
        <OnViewAnimation duration={1} translateX={-70}>Get In</OnViewAnimation>
        <OnViewAnimation duration={1} translateX={70}>
          <span className="text-thirtyColor">Touch</span>
        </OnViewAnimation>
      </h2>
      <div className="flex flex-col nc1:flex-row nc1:items-center gap-10 xl:gap-20 mt-10">
        ...
        <div className="nc1:w-[46%]">
          ...
          <div className="space-y-4 xl:space-y-6">
            ...
            <OnViewAnimation duration={1.3} translateY={50}>
