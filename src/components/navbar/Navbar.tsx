  ...
  return (
    <>
      ...
      <PageLoadAnimation duration={1} translateY={-100}>
        <nav className={`relative w-full xl:max-w-112.5 xl:mx-auto flex items-center justify-between py-4 pl-5 pr-6 x:pr-8 rounded-[13px] border border-[#0e122b10] backdrop-blur-2xl`}>
          {
            isHome ? (
              <Logo />
            ) : (
